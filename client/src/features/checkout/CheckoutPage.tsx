...
export default function CheckoutPage() {
  ...
  //Used to reset form values coming from API for saved address.
  useEffect(() => {
  ...
  async function submitOrder(data: FieldValues) {
    ...
    try {
      ...
      if (paymentResult.paymentIntent?.status === 'succeeded') {
        const orderNo = await agent.Order.create({
          saveAddress,
          shippingAddress,
        });
